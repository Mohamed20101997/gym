                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" name="price" value="{{ old('price') }}" class="form-control">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea  name="description" rows="4" cols="50" id="editor" class="form-control">{{old('description')}}</textarea>
